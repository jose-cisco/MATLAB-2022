...
%IMAGE_PROCESSING MATLAB code file for IMAGE_PROCESSING.fig
...
%
%      IMAGE_PROCESSING('Property','Value',...) creates a new IMAGE_PROCESSING using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to IMAGE_PROCESSING_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      IMAGE_PROCESSING('CALLBACK') and IMAGE_PROCESSING('CALLBACK',hObject,...) call the
%      local function named CALLBACK in IMAGE_PROCESSING.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 26-Aug-2022 15:00:29
...
I = imread(image_file);
if index_selected == 1
    J = imnoise(I,'salt & pepper',z);
    imshow(J);
else index_selected == 2
    J = imnoise(I,'speckle',z);
    imshow(J);
end
